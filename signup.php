...
try {
    ...
    if ($chkprepare->rowCount() > 0) {
        ...
        (id,user_name,password,email_id,phone,rating,date,notification_id,profileimage_id,skill_id) 
        VALUES 
        (Null,:user_name,:password,:email_id,:phone,:rating,:date,:notification_id,:profileimage_id,:skill_id)";
