...
if (isset($_GET['subcategory_id'])) {
    ...
    $sql = "SELECT prj.*,pr.user_name as client_username, pr.rating as client_rating, pr.email_id as client_email FROM project prj JOIN profile pr on prj.client_id = pr.id  WHERE project_subcategory='$subcategory_id' AND project_status='Uploaded'";
